...
## 🖥️ Infrastructure & Tools Overview
...
### 🧩 Fleet Server  
Fleet Server connects Elastic Agents to Fleet and acts as a control plane for updating and managing many Elastic Agent connections.  
It is part of the Elastic stack and requires an Elasticsearch instance to run.
